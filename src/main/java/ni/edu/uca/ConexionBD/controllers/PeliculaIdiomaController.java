...
public class PeliculaIdiomaController {
	...
	@PostMapping("/agregar")
	public String AgregarPelIdi(@RequestBody PeliculaIdioma pi) {
	...
	public String EditarPelIdi(@RequestBody PeliculaIdioma pi, @PathVariable int id, Model model) {
	...
	public String EliminarPelIdi(@PathVariable int id, Model model) {
