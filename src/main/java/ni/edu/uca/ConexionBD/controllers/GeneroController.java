...
public class GeneroController {
	...
	@PostMapping("/agregar")
	public String AgregarGen(@RequestBody Genero g) {
		String msg = "Error al guardar registro...";
		int b = servicio.GuardarRegistro(g);
		if(b==1) msg = "Registro guardado satisfactoriamente...";
		return msg;
	}
	
	@PutMapping("/actualizar/{id}")
	public String EditarGen(@RequestBody Genero g, @PathVariable int id, Model model) {
		String msg = "Error al editar registro...";
		//g.setIdGenero(id);
		int b = servicio.EditarRegistro(g);
